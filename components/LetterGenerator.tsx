...
const LetterGenerator: React.FC<LetterGeneratorProps> = ({ institute, students, onClose }) => {
  ...
  const [letterBody, setLetterBody] = useState({
    ...
    content2: " 	فترة دروس النقد: وفيها تخصص حصتان من يوم التدريب لكل مجموعة.
	فترة التدريب المنفصلة: وفيها يخصص لكل طالب حصتان في اليوم الواحد للتدريس.
كما يسر الكلية اختياركم ممتحنين للطلاب وذلك كالآتي:
	الدرجة المخصصة للمشرف الخارجي: (خمسون درجة).
	الدرجة المخصصة للمشرف الداخلي: (المعلم الأول – شيخ المعهد) (عشرون درجة).
  ."
  });
